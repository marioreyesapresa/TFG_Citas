...
urlpatterns = [
    ...
    path('aceptar/<int:propuesta_id>/', views.aceptar_propuesta, name='aceptar_propuesta'),
    path('rechazar/<int:propuesta_id>/', views.rechazar_propuesta, name='rechazar_propuesta'),
